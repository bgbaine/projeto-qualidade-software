...
|------|-----------------|
| Bernardo | Elaboração dos casos de teste e execução do login |
| Bryan | Execução dos testes de busca e registro de evidências |
| Filipe | Análise dos resultados e redação do relatório |
| Pedro | Revisão geral e reflexão crítica |
